...
from ...serializers.user.applicantPledgeSerializer import ApplicantPledgeSerializer
from ...models.applicant import Applicant


class ApplicantPledge(GenericAPIView):
    def put(self, request):
        applicant = ApplicantPledgeSerializer(data=self.request.data)

...
def SmsUnregistered():
    ...
    try:
        while True:
            request = urllib.Request("https://my.um.edu.sa/backend/sms/unregistered/run", json.dumps({"last_id": saved_last.last_id}).encode("utf-8"))
...
schedule.every(12).hours.do(SmsUnregistered)
